...
class AdvancedBot(BaseBot):
    ...
    "stop - Stop emote\n"
    "!help - Show help\n"
    "!spam <message_count> - Send spam messages\n"
    "!tele @username [vip|vip1|dj|custom_location] - Teleport user\n"
    "!tele to @username - Teleport to user\n"
    "!tele me @username - Teleport user to admin\n"
    "!tele me all - Teleport everyone to admin\n"
    "!heart <count> @username - Send purple hearts\n"
    "!heart all - Send purple hearts to everyone\n"
    "!clap <count> @username - Send clap\n"
    "!clap all - Send clap to everyone\n"
    "!wink <count> @username - Send wink\n"
    "!wink all - Send wink to everyone\n"
    "!wave <count> @username - Send wave\n"
    "!wave all - Send wave to everyone\n"
    ...
    "!dj - Teleport to DJ\n"
    "!down - Teleport downstairs\n"
    "!ban @username - Ban user\n"
    "!unban @username - Unban user\n"
    "!dancechain - Start emote chain\n"
    "!addtele <location_name> - Save a new teleport location\n"
    "!deltele <location_name> - Delete a teleport location\n"
    "!welcome <message> - Set welcome message\n"
    "!addadmin @username - Add admin (Host only)\n"
    "!removeadmin @username - Remove admin (Host only)\n"
    "!emotebot <emote_name/emote_number> - Change the bot's continuous emote (Admin only)\n"
    "!loopchat <message> - Set the bot's repeating chat/spam message (Admin only)\n"
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "697f5666c2fa52e4cd74641a")
